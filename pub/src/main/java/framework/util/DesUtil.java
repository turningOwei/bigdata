...
public class DesUtil {
	public static void main(String[] args) {
		...
		String key1 = "aG9uZ3NoaWdyb3VwLmNvbQ==";
		String key2 = "2";
		String key3 = "3";
		String data = "xcdfs2016";
		String str = desObj.strEnc(data, key1, null, null);
		// System.out.println(str);
		String dec = desObj.strDec(str, key1, null, null);
		// System.out.println(dec);

		// DF65580746F37E6E

		String msg = "xcdfs2016";
		int[] bt = desObj.strToBt(msg);

		String key = "aG9uZ3NoaWdyb3VwLmNvbQ==";
		int[] keyB = desObj.strToBt(key);

		int[] encByte = desObj.enc(bt, keyB);

		String enchex = desObj.bt64ToHex(encByte);
