...
public class StringUtil {
	...
	public static String generateRandom(int size) {
		...
		Double max = Math.pow(10d, size);

		Integer s = random.nextInt(max.intValue()) % (max.intValue() + 1);
		int len = size - s.toString().length();
	...
	/**
	 * @Title: StringsSplitToList
	 * @Description: TODO(根据分隔符返回list)
	 * @param @param str
	 * @param @param separator
	 * @param @return 设定文件
	 * @return List<String> 返回类型
	 */
	public static List<String> StringsSplitToList(String str, String separator) {
		List<String> list = new ArrayList<String>();
