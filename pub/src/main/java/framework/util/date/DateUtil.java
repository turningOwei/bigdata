...
public class DateUtil {
	...
	public static String getAliyunMonitorRequestStartDate() {
		...
		String startDateStr = DateUtil.DateToString(startDate,
				DateStyle.ALIYUN_MONITOR_YYYY_MM_DD_t_HH_MM_SS_z);
		return startDateStr;
	}
	 ...
	 */
	public static List<String> getDatesByStartDateAndEndDate(
